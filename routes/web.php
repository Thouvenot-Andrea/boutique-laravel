...
Route::get('/products/category/{category_id}', [ProductController::class, 'index'])->name('products');
...
Route::get('/{post}/edit', [ProductController::class, 'edit'])->name('products.edit');
Route::post('/{post}/edit', [ProductController::class, 'update'])->name('products.update');
