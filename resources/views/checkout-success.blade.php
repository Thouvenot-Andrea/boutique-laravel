<x-app-layout>
    ...
    <dl class="mt-10 space-y-6 text-sm font-medium text-gray-500">
        ...
        <div class="flex justify-between">
            ...
            <dd class="text-gray-900">{{number_format(($order->deliveryFee->price)/100,2)}} €</dd>
        </div>
        <div class="flex justify-between border-t border-gray-200 pt-6 text-gray-900">
            <dt class="text-base">Total</dt>
            <dd class="text-base">{{number_format(($order->total + $order->deliveryFee->price)/100,2)}} €</dd>
        </div>
    </dl>
    <div class="mx-auto w-full max-w-lg">
        <button type="button"
        ...
        <form class="mt-6">
            ...
            <div class="mt-6 flex space-x-2">
                ...
                <label for="terms" class="text-sm text-gray-500">I have read the terms and conditions
                    and agree to the sale of my personal information to the highest bidder.</label>
            </div>
        ...
        <div class="mt-10 divide-y divide-gray-200 border-b border-t border-gray-200">
            <button type="button" disabled
                    class="w-full cursor-auto py-6 text-left text-lg font-medium text-gray-500">Payment
                details
            </button>
            <button type="button" disabled
                    class="w-full cursor-auto py-6 text-left text-lg font-medium text-gray-500">Shipping
                address
            </button>
            <button type="button" disabled
                    class="w-full cursor-auto py-6 text-left text-lg font-medium text-gray-500">Billing
                address
            </button>
            <button type="button" disabled
                    class="w-full cursor-auto py-6 text-left text-lg font-medium text-gray-500">Review
            </button>
        </div>
    </div>
