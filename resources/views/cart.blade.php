                ...
                <div class=" px-6 md:flex md:space-x-6 xl:px-5 mx-20">
                    <div class="flex flex-col w-full">
                        @foreach($productsWithQuantities as $id => $quantity)
                            ...
                            <div
                                class="rounded-lg mb-6 bg-white p-6 shadow-md flex flex-col md:flex-row items-center">
                                ...
                                <div class="flex flex-col">
                                    <form class="flex items-center border-gray-100" method="post"
                    ...
                    <div class="my-6  rounded-lg border bg-white p-6 shadow-md md:mt-0 md:w-1/3">
                        ...
                        <form action="{{route('cart.checkout')}}" method="POST">
                            @csrf
                            <button
                                class="mt-6 w-full rounded-md bg-primary py-1.5 font-medium text-blue-50 hover:bg-accent">
                                Checkout
                            </button>
                        </form>
                    </div>
